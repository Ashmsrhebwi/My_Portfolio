    ...
    <form action="<?php echo e(route('admin.admins.store')); ?>" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" id="name" class="form-control" 
                   value="<?php echo e(old('name')); ?>" placeholder="Enter admin name" required>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
            ...
            <input type="email" name="email" id="email" class="form-control" 
                   value="<?php echo e(old('email')); ?>" placeholder="Enter admin email" required>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Shahm.s\Desktop\MyPortfilio\laravel\resources\views/admin/admins/create.blade.php ENDPATH**/ ?>