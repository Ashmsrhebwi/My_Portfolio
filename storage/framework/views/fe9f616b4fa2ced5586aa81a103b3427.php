...
<body>
    <form method="POST" action="<?php echo e(route('admin.verify.otp')); ?>">
        <?php echo csrf_field(); ?>
        <div class="container">
            <div class="logo">
...
</html><?php /**PATH C:\Users\Shahm.s\Desktop\MyPortfilio\laravel\resources\views/admin/verify-otp.blade.php ENDPATH**/ ?>